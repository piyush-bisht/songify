...
export default class Categories extends Component {
    ...
    constructor(props) {
        ...
        this.state={
            ...
            images:     [
                            "https://pyxis.nymag.com/v1/imgs/3a3/b1f/2141226b8ab1ae07afe4b541ee0d2b0825-11-yic-pop-essay.rsquare.w700.jpg",
    ...
    render() {
    const {categories,images,rec_cat,rec_images,playList} = this.state;
    return (
        <div className="Cat-Container">
            ...
            {console.log(playList),
                playList.map(data =>{
                    //console.log(index);
                    return <Category title={data.name} image={data.icons[0].url}/>
                })
            }
